...
static void
valent_presenter_plugin_watch_local_state (ValentPresenterPlugin *self,
                                       gboolean               watch)
{
                                          ...
                                          JsonNode              *packet)
{
  ...
  if (valent_packet_get_double (packet, "dx", &dx) &&
      valent_packet_get_double (packet, "dy", &dy))
    {
      ...
      valent_input_adapter_pointer_motion (self->local_adapter, dx * 1000, dy * 1000);
      return;
    }
                                      ...
                                      ValentDeviceState   state)
{
  ...
  valent_presenter_plugin_watch_local_state (self, available);
...
valent_presenter_plugin_destroy (ValentObject *object)
{
  ...
  valent_presenter_plugin_watch_local_state (self, FALSE);
