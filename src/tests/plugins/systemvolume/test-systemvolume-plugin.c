...
static void
systemvolume_plugin_fixture_set_up (ValentTestPluginFixture *fixture,
...
static void
test_systemvolume_plugin_handle_request (ValentTestPluginFixture *fixture,
                                         gconstpointer            user_data)
{
  ...
  packet = valent_test_plugin_fixture_lookup_packet (fixture, "request-sinks");
  ...
  packet = valent_test_plugin_fixture_lookup_packet (fixture, "request-mute");
  valent_test_plugin_fixture_handle_packet (fixture, packet);
