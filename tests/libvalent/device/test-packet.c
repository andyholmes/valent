...
static void
valent_packet_from_stream_error_cb (GInputStream  *stream,
                                    GAsyncResult  *result,
                                    GError       **error)
{
  g_autoptr (JsonNode) packet = NULL;
                       ...
                       gconstpointer  user_data)
{
  ...
  valent_packet_from_stream (in,
                             -1,
                             NULL,
                             (GAsyncReadyCallback) valent_packet_from_stream_error_cb,
                             &error);
